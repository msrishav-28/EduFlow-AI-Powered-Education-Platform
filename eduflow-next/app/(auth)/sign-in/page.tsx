    ...
    <AppShell>
      <div className="mx-auto max-w-md">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <Button className="w-full" disabled={isSubmitting || !auth}>{isSubmitting ? 'Signing in…' : 'Continue'}</Button>
        </form>
        ...
        <p className="mt-4 text-sm text-white/60">No account? <Link className="underline" href="/sign-up">Sign up</Link></p>
      </div>
    </AppShell>
  )
}
